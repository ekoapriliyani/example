...
class InspeksiCtController extends Controller
{
    ...
    public function create()
    {
        ...
        $nextNomor = "{$prefix}{$paddedNumber}"; // Hasil: INSCT202606001
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('inspeksi_ct.index')->with('success', "Data inspeksi {$fixNomorInspeksi} berhasil ditambahkan");
    }
    ...
    public function toggleApproval($id)
    {
        ...
        $inspeksi = InspeksiCt::findOrFail($id);
