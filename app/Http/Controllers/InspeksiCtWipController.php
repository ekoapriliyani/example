...
class InspeksiCtWipController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $wip = InspeksiCtWip::create([
            ...
            'l_produk_1' => $request->l_produk_1 ?? null,
            'l_produk_2' => $request->l_produk_2 ?? null,
            'l_produk_3' => $request->l_produk_3 ?? null,
            'l_produk_4' => $request->l_produk_4 ?? null,
            'l_produk_5' => $request->l_produk_5 ?? null,
