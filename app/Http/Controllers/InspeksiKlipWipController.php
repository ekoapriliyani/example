...
class InspeksiKlipWipController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $slitting = InspeksiKlipWip::create([
            ...
            'jarak_antar_klip1' => $validated['jarak_antar_klip1'],
            'jarak_antar_klip2' => $validated['jarak_antar_klip2'],
            'jarak_antar_klip3' => $validated['jarak_antar_klip3'],
            'jarak_antar_klip4' => $validated['jarak_antar_klip4'],
            'jarak_antar_klip5' => $validated['jarak_antar_klip5'],
            'kerapatan' => $validated['kerapatan'],
