...
return new class extends Migration
{
    ...
    {
        Schema::create('inspeksi_pound_wips', function (Blueprint $table) {
            $table->id();
            $table->foreignId('inspeksi_pound_id')->constrained('inspeksi_pounds')->onDelete('cascade'); // relasi ke header
    ...
    {
        Schema::dropIfExists('inspeksi_pound_wips');
    }
};
