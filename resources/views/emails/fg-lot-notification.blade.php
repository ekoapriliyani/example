...
<head>
    ...
    <style>
        ...
        td:first-child { width: 40%; font-weight: 700; color: #374151; }
    </style>
</head>
<body>
    <div class="container">
        ...
        <div class="body">
            ...
            <table>
                <tr><td>Lot Number</td><td>{{ $lotNumber }}</td></tr>
                <tr><td>Nomor Inspeksi</td><td>{{ $nomorInspeksi }}</td></tr>
                <tr><td>PRO ID</td><td>{{ $proId }}</td></tr>
                <tr><td>Status</td><td>{{ $status }}</td></tr>
                <tr><td>Quantity</td><td>{{ $qty }}</td></tr>
                <tr><td>Tanggal Inspeksi</td><td>{{ $tanggal }}</td></tr>
                <tr><td>Diinput Oleh</td><td>{{ $user }}</td></tr>
            </table>
        </div>
    </div>
</body>
