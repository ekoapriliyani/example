    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Daftar Inspeksi Incoming Project') }}
            </h2>

            <a href="{{ route('incomingproject.create') }}"
                ...
                Tambah Inspeksi Incoming Project
            </a>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200 p-6">
                <form action="{{ route('incomingproject.index') }}" method="GET" class="flex gap-2">
                                        ...
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td class="px-4 py-3 text-right whitespace-nowrap space-x-2">
                                                ...
                                                <form id="delete-form-{{ $item->id }}"
                                                    action="{{ route('incomingproject.destroy', $item->id) }}"
