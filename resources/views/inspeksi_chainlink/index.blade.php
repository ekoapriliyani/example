    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Daftar Inspeksi Chainlink') }}
            </h2>

            <a href="{{ route('inspeksi_chainlink.create') }}"
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200 p-6">
                <form action="{{ route('inspeksi_chainlink.index') }}" method="GET"
                            ...
                            <table class="min-w-full divide-y divide-gray-200 bg-white text-sm">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-4 py-3 font-semibold text-gray-900 text-left w-16">Aksi</th>
                                        ...
                                        <th class="px-4 py-3 font-semibold text-gray-900 text-left">Panjang (Jumlah
                                            Lubang per roll)</th>
                                        <th class="px-4 py-3 font-semibold text-gray-900 text-left">Jumlah Counter</th>
                                        <th class="px-4 py-3 font-semibold text-gray-900 text-left">Lebar (Jumlah
                                            Lubang)</th>
                                ...
                                <tbody class="divide-y divide-gray-200">
                                        ...
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td class="px-4 py-3">
                                                <div class="flex items-center justify-end gap-2">
                                                    <!-- View (selalu tampil) -->
                                                    <a href="{{ route('inspeksi_chainlink.show', $item->id) }}"
                                                    ...
                                                    @if (!$item->isApproved())
                                                        <!-- Edit -->
                                                        <a href="{{ route('inspeksi_chainlink.edit', $item->id) }}"
                                                        ...
                                                        <form id="delete-form-{{ $item->id }}"
                                                            action="{{ route('inspeksi_chainlink.destroy', $item->id) }}"
                                            ...
                                            <td class="px-4 py-3 font-medium text-gray-900">{{ $item->jml_lubang_p }}
                                            </td>
                                            <td class="px-4 py-3 font-medium text-gray-900">{{ $item->jml_counter }}
                                            </td>
                                            <td class="px-4 py-3 font-medium text-gray-900">{{ $item->jml_lubang_l }}
                                            </td>
                                            <td class="px-4 py-3 font-medium text-gray-900">
                                                {{ $item->mesin->mesin_id }}
                                            </td>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="15" class="px-4 py-8 text-center text-gray-500 italic">
