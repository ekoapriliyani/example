    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-2">
                ...
                @php
                    $isApproved = $inspeksi_ct->approval_status === 'APPROVED';
                @endphp
                <div class="flex items-center gap-2">
                    ...
                    @else
                        <a href="{{ route('inspeksi_ct.wip', $inspeksi_ct->id) }}"
                    ...
                    @else
                        <a href="{{ route('inspeksi_ct.fg', $inspeksi_ct->id) }}"
                    ...
                    <div class="flex items-start justify-between">
                        <dl class="grid grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-4">
                            ...
                            <div>
                                ...
                                <dd class="text-lg font-semibold text-gray-900">
                                    {{ $inspeksi_ct->total_prod }} {{ $inspeksi_ct->satuan }}
                                </dd>
                            </div>
                            <div>
                                    ...
                                    <tr class="transition-colors hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center gap-3">
                                                ...
                                                @else
                                                    <a href="{{ route('inspeksi_ct_wip.edit', $wip->id) }}"
                                                ...
                                                @else
                                                    <form action="{{ route('inspeksi_ct_wip.destroy', $wip->id) }}"
            ...
            <div class="overflow-hidden border border-gray-200 bg-white shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="overflow-x-auto rounded-lg border border-gray-200">
                                    ...
                                    <tr class="transition-colors hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center gap-3">
                                                ...
                                                {{-- QR Code --}}
                                                @if ($fg->lot_number)
                                                    <a href="{{ route('inspeksi_ct_fg.qrcode', $fg->id) }}"
                                                        target="_blank"
                        ...
                        {{-- modal detail fg --}}
                        @foreach ($inspeksi_ct->inspeksiCtFg as $fg)
                            <div id="detail-{{ $fg->id }}"
                        ...
                        {{-- modal detail wip --}}
                        @foreach ($inspeksi_ct->inspeksiCtWip as $wip)
    ...
    <div id="print-section" class="hidden">
        ...
        <table width="100%" cellpadding="5" cellspacing="0"
            ...
            <tr>
                ...
                <td style="width: 30%;">: {{ $inspeksi_ct->nomor_inspeksi }}</td>
            </tr>
            <tr>
                <td style="font-weight: bold;">PRO Number</td>
                <td>: {{ $inspeksi_ct->pro->pro_id }}</td>
                <td style="font-weight: bold;">Description</td>
                <td>: {{ $inspeksi_ct->pro->description }}</td>
            </tr>
            <tr>
                <td style="font-weight: bold;">QTY Ordered</td>
                <td>: {{ $inspeksi_ct->pro->qty }}</td>
                <td style="font-weight: bold;">Total Prod Per Shift</td>
                <td>: {{ $inspeksi_ct->total_prod }} {{ $inspeksi_ct->satuan }}</td>
            </tr>
            <tr>
                <td style="font-weight: bold;">Shift</td>
                <td>: {{ $inspeksi_ct->shift }}</td>
                <td style="font-weight: bold;">Mesin</td>
                <td>: {{ $inspeksi_ct->mesin->nama_mesin }}</td>
            </tr>
        </table>
            ...
            <table width="100%" cellpadding="4" cellspacing="0"
                ...
                <thead>
                    <tr style="background-color: #f0f0f0;">
                        ...
                        <th style="border: 1px solid #000; padding: 5px; text-align: center; width: 14%;">Lot Number
                        </th>
                        <th style="border: 1px solid #000; padding: 5px; text-align: center; width: 14%;">Inspektor
                        </th>
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p style="margin: 0; border-top: 1px solid #000; width: 200px; padding-top: 5px;">
                        {{ $inspeksi_ct->inspeksiCtWip->first()->user->name ?? '.................' }}</p>
