        ...
        <div class="caption">
            <table class="info-table">
                ...
                <tr>
                    ...
                    <td class="separator">:</td>
                    <td class="value">{{ $inspeksiFencing->nomor_inspeksi }}</td>
                </tr>
                <tr>
                    <td class="">PRO ID</td>
                    <td class="separator">:</td>
                ...
                <tr>
                    <td class="">Type</td>
                    <td class="separator">:</td>
                    <td class="value">{{ $fg->type }}</td>
                </tr>
                <tr>
                    <td class="">Nama Mesin</td>
                    <td class="separator">:</td>
                    <td class="value">
                        {{ $inspeksiFencing->mesin->mesin_id }}
                    </td>
                </tr>
                <tr>
                    <td class="">Shift</td>
                    <td class="separator">:</td>
                    <td class="value">{{ $inspeksiFencing->shift }}</td>
                </tr>
                <tr>
                    <td class="">Status</td>
                    <td class="separator">:</td>
                ...
                <tr>
                    <td class="">Tanggal</td>
                    <td class="separator">:</td>
                    <td class="value">{{ $inspeksiFencing->tanggal }}</td>
                </tr>
                <tr>
