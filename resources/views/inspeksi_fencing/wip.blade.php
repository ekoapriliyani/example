                    ...
                    <form action="{{ route('inspeksi_fencing_wip.store') }}" method="POST"
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                            <div>
                                ...
                                <div class="relative mt-1">
                                    <x-text-input id="p_product_act" name="p_product_act" type="number"
                                        step="0.01" class="block w-full pr-12" :value="old('p_product_act')" required
                                        placeholder="0.00" />
                                    <div
                                        class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3 text-sm text-gray-400">
                                        mm
                            ...
                            <div>
                                ...
                                <div class="relative mt-1">
                                    <x-text-input id="l_product_act" name="l_product_act" type="number"
                                        step="0.01" class="block w-full pr-12" :value="old('l_product_act')" required
                                        placeholder="0.00" />
                                    <div
                                        class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3 text-sm text-gray-400">
                                        mm
                            ...
                            <div>
                                ...
                                <div class="relative mt-1">
                                    <x-text-input id="t_product_act" name="t_product_act" type="number"
                                        step="0.01" class="block w-full pr-12" :value="old('t_product_act')" required
                                        placeholder="0.00" />
                                    <div
                                        class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3 text-sm text-gray-400">
                                        mm
