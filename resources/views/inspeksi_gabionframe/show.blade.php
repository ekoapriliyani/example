    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold leading-tight text-gray-800">
                {{ __('Detail Inspeksi Gabionframe') }}
            </h2>
            <div class="flex gap-2">
                ...
                @php
                    $isApproved = $inspeksiGabionframe->approval_status === 'APPROVED';
                @endphp
                <div class="flex items-center gap-2">
                    ...
                    @else
                        <a href="{{ route('inspeksi_gabionframe.wip', $inspeksiGabionframe->id) }}"
        ...
        <div class="mx-auto max-w-7xl space-y-8 sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden border border-gray-200 bg-white shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="mb-4 flex items-center gap-2">
                        ...
                        <h3 class="text-lg font-bold text-gray-800">Hasil Inspeksi WIP Gabionframe</h3>
                    </div>
                    ...
                    <div class="overflow-x-auto rounded-lg border border-gray-200">
                        <table class="min-w-full divide-y divide-gray-200 text-left text-sm">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                @forelse ($inspeksiGabionframe->inspeksiGabionframeWip as $wip)
                                    <tr class="transition-colors hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center gap-3">
                                                ...
                                                @else
                                                    <a href="{{ route('inspeksi_gabionframe_wip.edit', $wip->id) }}"
            ...
            <div class="overflow-hidden border border-gray-200 bg-white shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="overflow-x-auto rounded-lg border border-gray-200">
                        {{-- modal detail wip --}}
                        @foreach ($inspeksiGabionframe->inspeksiGabionframeWip as $wip)
                ...
                <div class="p-6">
                    <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
                        ...
                        <div class="flex items-center gap-4">
                            <!-- Status -->
                            @if ($inspeksiGabionframe->isApproved())
                                <span
                            ...
                            @if (in_array(auth()->user()->role, ['supervisor', 'manager', 'administrator']))
                                <form id="approval-form-{{ $inspeksiGabionframe->id }}"
                                    action="{{ route('inspeksi-gabionframe.toggle', $inspeksiGabionframe->id) }}"
                                    method="POST" class="hidden">
                                    @csrf
                                    @method('PATCH')
                                </form>
                                <button type="button"
                                    onclick="confirmApproval({{ $inspeksiGabionframe->id }}, '{{ $inspeksiGabionframe->isApproved() ? 'unapprove' : 'approve' }}')"
                                    class="{{ $inspeksiGabionframe->isApproved()
    ...
    <div id="print-section" class="hidden">
            ...
            <tr>
                ...
                <td style="width: 60%; vertical-align: middle; text-align: center;">
                    <h1 style="font-size: 18pt; font-weight: bold; margin: 0; font-family: Arial, sans-serif;">LAPORAN
                        INSPEKSI HARIAN GABION FRAME</h1>
                </td>
                <td
                    ...
                    <table cellpadding="3" cellspacing="0" style="border: 1px solid #000; margin-left: auto;">
                        <tr>
                            <td style="font-weight: bold; font-size: 10pt;">BM-F-QC-15 R00</td>
                        </tr>
                    </table>
                </td>
            </tr>
        ...
        <table width="100%" cellpadding="5" cellspacing="0"
            ...
            <tr>
                ...
                <td style="width: 30%;">: {{ $inspeksiGabionframe->nomor_inspeksi }}</td>
            </tr>
            <tr>
                <td style="font-weight: bold;">PRO Number</td>
                <td>: {{ $inspeksiGabionframe->pro->pro_id }}</td>
                <td style="font-weight: bold;">Description</td>
                <td>: {{ $inspeksiGabionframe->pro->description }}</td>
            </tr>
            <tr>
                <td style="font-weight: bold;">QTY Ordered</td>
                <td>: {{ $inspeksiGabionframe->pro->qty }}</td>
                <td style="font-weight: bold;">Total Prod Per Shift</td>
                <td>: {{ $inspeksiGabionframe->total_prod }}</td>
            </tr>
            <tr>
                <td style="font-weight: bold;">Shift</td>
                <td>: {{ $inspeksiGabionframe->shift }}</td>
                <td style="font-weight: bold;">Mesin</td>
                <td>: {{ $inspeksiGabionframe->mesin->nama_mesin }}</td>
            </tr>
        </table>
            ...
            <table width="100%" cellpadding="4" cellspacing="0"
                ...
                <thead>
                    <tr style="background-color: #f0f0f0;">
                        ...
                        <th style="border: 1px solid #000; padding: 5px; text-align: center; width: 5%;">P Act</th>
                        <th style="border: 1px solid #000; padding: 5px; text-align: center; width: 5%;">L Act</th>
                        <th style="border: 1px solid #000; padding: 5px; text-align: center; width: 6%;">D Kwt Galv Anyam</th>
                        <th style="border: 1px solid #000; padding: 5px; text-align: center; width: 6%;">D Kwt Galv Frame</th>
                        <th style="border: 1px solid #000; padding: 5px; text-align: center; width: 6%;">D Kwt PVC Anyam</th>
                        <th style="border: 1px solid #000; padding: 5px; text-align: center; width: 6%;">D Kwt PVC Frame</th>
                ...
                <tbody>
                    @forelse ($inspeksiGabionframe->inspeksiGabionframeWip as $wip)
                        <tr>
                            ...
                            <td style="border: 1px solid #000; padding: 4px; text-align: center;">{{ $wip->d_kwtGal_anyam }}</td>
                            <td style="border: 1px solid #000; padding: 4px; text-align: center;">{{ $wip->d_kwtGal_frame }}</td>
                            <td style="border: 1px solid #000; padding: 4px; text-align: center;">{{ $wip->d_kwtPvc_anyam }}</td>
                            <td style="border: 1px solid #000; padding: 4px; text-align: center;">{{ $wip->d_kwtPvc_frame }}</td>
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p style="margin: 0; border-top: 1px solid #000; width: 200px; padding-top: 5px;">
                        {{ $inspeksiGabionframe->inspeksiGabionframeWip->first()->user->name ?? '.................' }}</p>
                ...
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <br><br><br>
                    <p style="margin: 0; border-top: 1px solid #000; width: 200px; padding-top: 5px;">
                        {{ $inspeksiGabionframe->approver->name ?? '.................' }}</p>
