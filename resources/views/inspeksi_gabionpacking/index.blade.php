    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold leading-tight text-gray-800">
                {{ __('Daftar Inspeksi Gabionpacking') }}
            </h2>

            <a href="{{ route('inspeksi_gabionpacking.create') }}"
                                        ...
                                        <tr class="transition-colors hover:bg-gray-50">
                                            ...
                                            <td class="px-4 py-3">
                                                <div class="flex items-center justify-end gap-2">
                                                    <!-- View (selalu tampil) -->
                                                    <a href="{{ route('inspeksi_gabionpacking.show', $item->id) }}"
                                                    ...
                                                    @if (!$item->isApproved())
                                                        <!-- Edit -->
                                                        <a href="{{ route('inspeksi_gabionpacking.edit', $item->id) }}"
                                                        ...
                                                        <form id="delete-form-{{ $item->id }}"
                                                            action="{{ route('inspeksi_gabionpacking.destroy', $item->id) }}"
