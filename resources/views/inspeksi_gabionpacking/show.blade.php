    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold leading-tight text-gray-800">
                {{ __('Detail Inspeksi Gabion Packing') }}
            </h2>
            <div class="flex gap-2">
                ...
                @php
                    $isApproved = $inspeksiGabionpacking->approval_status === 'APPROVED';
                @endphp
                <div class="flex items-center gap-2">
                    ...
                    @else
                        <a href="{{ route('inspeksi_gabionpacking.fg', $inspeksiGabionpacking->id) }}"
                    ...
                    <div class="overflow-x-auto rounded-lg border border-gray-200">
                        <table class="min-w-full divide-y divide-gray-200 text-left text-sm">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                @forelse ($inspeksiGabionpacking->inspeksiGabionpackingFg as $fg)
                                    <tr class="transition-colors hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center gap-3">
                                                ...
                                                @else
                                                    <a href="{{ route('inspeksi_gabionpacking_fg.edit', $fg->id) }}"
                                                ...
                                                @else
                                                    <form id="delete-form-{{ $fg->id }}"
                                                        action="{{ route('inspeksi_gabionpacking_fg.destroy', $fg->id) }}"
                                                        ...
                                                        <button type="button"
                                                            onclick="confirmDelete('{{ $fg->id }}', '{{ $fg->nomor_inspeksi }}')"
                        ...
                        {{-- modal detail fg --}}
                        @foreach ($inspeksiGabionpacking->inspeksiGabionpackingFg as $fg)
                            <div id="detail-{{ $fg->id }}"
                ...
                <div class="p-6">
                    <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h3 class="text-xl font-bold text-gray-900">
                                    Approval Inspeksi Gabion Packing
                                </h3>
                        ...
                        <div class="flex items-center gap-4">
                            <!-- Status -->
                            @if ($inspeksiGabionpacking->isApproved())
                                <span
                            ...
                            @if (in_array(auth()->user()->role, ['supervisor', 'manager', 'administrator']))
                                <form id="approval-form-{{ $inspeksiGabionpacking->id }}"
                                    action="{{ route('inspeksi-gabionpacking.toggle', $inspeksiGabionpacking->id) }}"
                                    method="POST" class="hidden">
                                    @csrf
                                    @method('PATCH')
                                </form>
                                <button type="button"
                                    onclick="confirmApproval({{ $inspeksiGabionpacking->id }}, '{{ $inspeksiGabionpacking->isApproved() ? 'unapprove' : 'approve' }}')"
                                    class="{{ $inspeksiGabionpacking->isApproved()
    ...
    <div id="print-section" class="hidden">
            ...
            <tr>
                ...
                <td style="width: 60%; vertical-align: middle; text-align: center;">
                    <h1 style="font-size: 18pt; font-weight: bold; margin: 0; font-family: Arial, sans-serif;">LAPORAN
                        INSPEKSI HARIAN GABION PACKING</h1>
                </td>
                <td
                    ...
                    <table cellpadding="3" cellspacing="0" style="border: 1px solid #000; margin-left: auto;">
                        <tr>
                            <td style="font-weight: bold; font-size: 10pt;">BM-F-QC-23 R00</td>
                        </tr>
                    </table>
                </td>
            </tr>
        ...
        <table width="100%" cellpadding="5" cellspacing="0"
            ...
            <tr>
                ...
                <td style="width: 30%;">: {{ $inspeksiGabionpacking->nomor_inspeksi }}</td>
            </tr>
            <tr>
                <td style="font-weight: bold;">PRO Number</td>
                <td>: {{ $inspeksiGabionpacking->pro->pro_id }}</td>
                <td style="font-weight: bold;">Description</td>
                <td>: {{ $inspeksiGabionpacking->pro->description }}</td>
            </tr>
            <tr>
                <td style="font-weight: bold;">QTY Ordered</td>
                <td>: {{ $inspeksiGabionpacking->pro->qty }}</td>
                <td style="font-weight: bold;">Total Prod Per Shift</td>
                <td>: {{ $inspeksiGabionpacking->total_prod }} {{ $inspeksiGabionpacking->satuan }}</td>
            </tr>
            <tr>
                <td style="font-weight: bold;">Shift</td>
                <td>: {{ $inspeksiGabionpacking->shift }}</td>
                <td></td>
                <td></td>
            </tr>
        </table>
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p style="margin: 0; border-top: 1px solid #000; width: 200px; padding-top: 5px;">
                        {{ $inspeksiGabionpacking->inspeksiGabionpackingFg->first()->user->name ?? '.................' }}</p>
                ...
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <br><br><br>
                    <p style="margin: 0; border-top: 1px solid #000; width: 200px; padding-top: 5px;">
                        {{ $inspeksiGabionpacking->approver->name ?? '.................' }}</p>
