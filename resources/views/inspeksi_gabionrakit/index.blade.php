    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Daftar Inspeksi Gabion Rakit') }}
            </h2>

            <a href="{{ route('inspeksi_gabionrakit.create') }}"
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200 p-6">
                <form action="{{ route('inspeksi_gabionrakit.index') }}" method="GET" class="flex gap-2">
                            ...
                            <table class="min-w-full divide-y divide-gray-200 bg-white text-sm">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-4 py-3 font-semibold text-gray-900 text-left">Diameter</th>
                                        <th class="px-4 py-3 font-semibold text-gray-900 text-left">Ukuran</th>
                                        ...
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td class="px-4 py-3">
                                                <div class="flex items-center justify-end gap-2">
                                                    <!-- View (selalu tampil) -->
                                                    <a href="{{ route('inspeksi_gabionrakit.show', $item->id) }}"
                                                    ...
                                                    @if (!$item->isApproved())
                                                        <!-- Edit -->
                                                        <a href="{{ route('inspeksi_gabionrakit.edit', $item->id) }}"
                                                        ...
                                                        <form id="delete-form-{{ $item->id }}"
                                                            action="{{ route('inspeksi_gabionrakit.destroy', $item->id) }}"
                                            ...
                                            <td class="px-4 py-3 font-medium text-gray-900">{{ $item->diameter }}
                                            </td>
                                            <td class="px-4 py-3 font-medium text-gray-900">{{ $item->ukuran }}
                                            </td>
