    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <p class="text-sm text-gray-500">
                Ref: <span class="font-mono font-bold text-indigo-600">{{ $inspeksiGabionrakit->nomor_inspeksi }}</span>
            </p>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="mx-auto max-w-4xl sm:px-6 lg:px-8">
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700">
                            ...
                            <strong>{{ $inspeksiGabionrakit->nomor_inspeksi }}</strong>.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="overflow-hidden border border-gray-200 bg-white shadow-sm sm:rounded-lg">
                <div class="p-8">
                    <form action="{{ route('inspeksi_gabionrakit_wip.store') }}" method="POST"
                        enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        <input type="hidden" name="inspeksi_gabionrakit_id" value="{{ $inspeksiGabionrakit->id }}">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <select id="type" name="type"
                                    ...
                                    required>
                                    <option value="Galvanized" {{ old('type') == 'Galvanized' ? 'selected' : '' }}>
                                        Galvanized</option>
                            ...
                            <div>
                                ...
                                <div class="relative mt-1">
                                    <x-text-input id="jml_sekat" name="jml_sekat" type="number" step="0.01"
                                        class="block w-full pr-12" :value="old('jml_sekat')" placeholder="0.00" />
                                    <div
                                        class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3 text-sm text-gray-400">
                                        -
                                    </div>
                        ...
                        <div class="flex items-center justify-end gap-4 border-t border-gray-100 pt-6">
                            <a href="{{ route('inspeksi_gabionrakit.show', $inspeksiGabionrakit->id) }}"
