                    ...
                    <div class="flex items-start justify-between">
                        <dl class="grid grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-4">
                            <div>
                                ...
                                <dd class="text-lg font-bold text-indigo-600">{{ $inspeksiKawatDuri->nomor_inspeksi }}
                                </dd>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <dd class="text-lg font-semibold text-gray-900">
                                    {{ $inspeksiKawatDuri->total_prod }} {{ $inspeksiKawatDuri->satuan }}
                                </dd>
                            </div>
                            <div>
                                    ...
                                    <tr class="transition-colors hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center gap-3">
                                                ...
                                                @else
                                                    <a href="{{ route('inspeksi_kawat_duri_wip.edit', $wip->id) }}"
                                                ...
                                                @else
                                                    <form
                                                        action="{{ route('inspeksi_kawat_duri_wip.destroy', $wip->id) }}"
                                    ...
                                    <tr class="transition-colors hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center gap-3">
                                                ...
                                                @else
                                                    <a href="{{ route('inspeksi_kawat_duri_fg.edit', $fg->id) }}"
                                                        class="inline-flex items-center rounded-md bg-yellow-100 p-2 text-yellow-600 transition hover:bg-yellow-200"
                                                        title="Edit">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                                                            fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                ...
                                                @else
                                                    <form
                                                        action="{{ route('inspeksi_kawat_duri_fg.destroy', $fg->id) }}"
                                                        method="POST" class="delete-form inline-block">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            @if (in_array(auth()->user()->role, ['supervisor', 'manager', 'administrator']))
                                <form id="approval-form-{{ $inspeksiKawatDuri->id }}"
                                    action="{{ route('inspeksi-kawat-duri.toggle', $inspeksiKawatDuri->id) }}"
                                ...
                                <button type="button"
                                    ...
                                    class="{{ $inspeksiKawatDuri->isApproved()
    ...
    <div id="print-section" class="hidden">
        ...
        <table width="100%" cellpadding="5" cellspacing="0"
            ...
            <tr>
                ...
                <td style="width: 30%;">: {{ $inspeksiKawatDuri->nomor_inspeksi }}</td>
            </tr>
            <tr>
                <td style="font-weight: bold;">PRO Number</td>
                <td>: {{ $inspeksiKawatDuri->pro->pro_id }}</td>
                <td style="font-weight: bold;">Description</td>
                <td>: {{ $inspeksiKawatDuri->pro->description }}</td>
            </tr>
            <tr>
                <td style="font-weight: bold;">QTY Ordered</td>
                <td>: {{ $inspeksiKawatDuri->pro->qty }}</td>
                <td style="font-weight: bold;">Total Prod Per Shift</td>
                <td>: {{ $inspeksiKawatDuri->total_prod }} {{ $inspeksiKawatDuri->satuan }}</td>
            </tr>
            <tr>
                <td style="font-weight: bold;">Shift</td>
                <td>: {{ $inspeksiKawatDuri->shift }}</td>
                <td style="font-weight: bold;">Type Coating</td>
                <td>: {{ $inspeksiKawatDuri->type_coating }}</td>
            </tr>
            <tr>
                <td style="font-weight: bold;">Mesin</td>
                <td>: {{ $inspeksiKawatDuri->mesin->nama_mesin }}</td>
                <td></td>
                <td></td>
            </tr>
        </table>
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p style="margin: 0; border-top: 1px solid #000; width: 200px; padding-top: 5px;">
                        {{ $inspeksiKawatDuri->inspeksiKawatDuriWip->first()->user->name ?? '.................' }}</p>
                ...
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <br><br><br>
                    <p style="margin: 0; border-top: 1px solid #000; width: 200px; padding-top: 5px;">
                        {{ $inspeksiKawatDuri->approver->name ?? '.................' }}</p>
