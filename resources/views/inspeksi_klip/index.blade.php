    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold leading-tight text-gray-800">
                {{ __('Daftar Inspeksi klip') }}
            </h2>

            <a href="{{ route('inspeksi_klip.create') }}"
    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden border border-gray-200 bg-white p-6 shadow-sm sm:rounded-lg">
                <form action="{{ route('inspeksi_klip.index') }}" method="GET" class="flex gap-2">
                                        ...
                                        <tr class="transition-colors hover:bg-gray-50">
                                            ...
                                            <td class="px-4 py-3">
                                                <div class="flex items-center justify-end gap-2">
                                                    <!-- View (selalu tampil) -->
                                                    <a href="{{ route('inspeksi_klip.show', $item->id) }}"
                                                    ...
                                                    @if (!$item->isApproved())
                                                        <!-- Edit -->
                                                        <a href="{{ route('inspeksi_klip.edit', $item->id) }}"
                                                        ...
                                                        <form id="delete-form-{{ $item->id }}"
                                                            action="{{ route('inspeksi_klip.destroy', $item->id) }}"
