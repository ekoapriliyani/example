    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold leading-tight text-gray-800">
                {{ __('Daftar Inspeksi Pound') }}
            </h2>

            <a href="{{ route('inspeksi_pound.create') }}"
    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden border border-gray-200 bg-white p-6 shadow-sm sm:rounded-lg">
                <form action="{{ route('inspeksi_pound.index') }}" method="GET"
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200 bg-white text-sm">
                                ...
                                <tbody class="divide-y divide-gray-200">
                                        ...
                                        <tr class="transition-colors hover:bg-gray-50">
                                            ...
                                            <td class="px-4 py-3">
                                                <div class="flex items-center justify-end gap-2">
                                                    <!-- View (selalu tampil) -->
                                                    <a href="{{ route('inspeksi_pound.show', $item->id) }}"
                                                    ...
                                                    @if (!$item->isApproved())
                                                        <!-- Edit -->
                                                        <a href="{{ route('inspeksi_pound.edit', $item->id) }}"
                                                        ...
                                                        <form id="delete-form-{{ $item->id }}"
                                                            action="{{ route('inspeksi_pound.destroy', $item->id) }}"
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="15" class="px-4 py-8 text-center italic text-gray-500">
