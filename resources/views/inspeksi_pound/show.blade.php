    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-2">
                ...
                @php
                    $isApproved = $inspeksi_pound->approval_status === 'APPROVED';
                @endphp
                <div class="flex items-center gap-2">
                    ...
                    @else
                        <a href="{{ route('inspeksi_pound.wip', $inspeksi_pound->id) }}"
        ...
        <div class="mx-auto max-w-7xl space-y-8 sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-start justify-between">
                        <dl class="grid grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-4">
                            ...
                            <div>
                                ...
                                <dd class="text-lg font-semibold text-gray-900">
                                    {{ $inspeksi_pound->mesin->nama_mesin }}
                                </dd>
                            </div>
                        </dl>
                    </div>
            ...
            <div class="overflow-hidden border border-gray-200 bg-white shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="mb-4 flex items-center gap-2">
                        ...
                        <h3 class="text-lg font-bold text-gray-800">Hasil Inspeksi WIP Razor Pound</h3>
                    </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 text-left text-sm">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-4 py-3 font-semibold text-gray-900">tebal_blade</th>
                                    ...
                                    <tr class="transition-colors hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center gap-3">
                                                ...
                                                @else
                                                    <a href="{{ route('inspeksi_pound_wip.edit', $wip->id) }}"
                                                ...
                                                @else
                                                    <form action="{{ route('inspeksi_pound_wip.destroy', $wip->id) }}"
            ...
            <div class="overflow-hidden border border-gray-200 bg-white shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="overflow-x-auto rounded-lg border border-gray-200">
                        {{-- modal detail wip --}}
                        @foreach ($inspeksi_pound->inspeksiPoundWip as $wip)
                    ...
                    <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            @if (in_array(auth()->user()->role, ['supervisor', 'manager', 'administrator']))
                                <form id="approval-form-{{ $inspeksi_pound->id }}"
                                    action="{{ route('inspeksi-pound.toggle', $inspeksi_pound->id) }}" method="POST"
                                    class="hidden">
                                    @csrf
                                    @method('PATCH')
                                </form>
                                <button type="button"
                                    onclick="confirmApproval({{ $inspeksi_pound->id }}, '{{ $inspeksi_pound->isApproved() ? 'unapprove' : 'approve' }}')"
                                    class="{{ $inspeksi_pound->isApproved()
    ...
    <div id="print-section" class="hidden">
            ...
            <tr>
                ...
                <td style="width: 60%; vertical-align: middle; text-align: center;">
                    <h1 style="font-size: 18pt; font-weight: bold; margin: 0; font-family: Arial, sans-serif;">LAPORAN
                        INSPEKSI HARIAN RAZOR POUND</h1>
                </td>
                <td
                    ...
                    <table cellpadding="3" cellspacing="0" style="border: 1px solid #000; margin-left: auto;">
                        <tr>
                            <td style="font-weight: bold; font-size: 10pt;">BM-F-QC-18 R00</td>
                        </tr>
                    </table>
                </td>
            </tr>
        ...
        <table width="100%" cellpadding="5" cellspacing="0"
            ...
            <tr>
                ...
                <td style="width: 30%;">: {{ $inspeksi_pound->nomor_inspeksi }}</td>
            </tr>
            <tr>
                <td style="font-weight: bold;">PRO Number</td>
                <td>: {{ $inspeksi_pound->pro->pro_id }}</td>
                <td style="font-weight: bold;">Description</td>
                <td>: {{ $inspeksi_pound->pro->description }}</td>
            </tr>
            <tr>
                <td style="font-weight: bold;">QTY Ordered</td>
                <td>: {{ $inspeksi_pound->pro->qty }}</td>
                <td style="font-weight: bold;">Total Prod Per Shift</td>
                <td>: {{ $inspeksi_pound->total_prod }} {{ $inspeksi_pound->satuan }}</td>
            </tr>
            <tr>
                <td style="font-weight: bold;">Shift</td>
                <td>: {{ $inspeksi_pound->shift }}</td>
                <td style="font-weight: bold;">Mesin</td>
                <td>: {{ $inspeksi_pound->mesin->nama_mesin }}</td>
            </tr>
        </table>
            ...
            <table width="100%" cellpadding="4" cellspacing="0"
                ...
                <thead>
                    <tr style="background-color: #f0f0f0;">
                        ...
                        <th style="border: 1px solid #000; padding: 5px; text-align: center; width: 7%;">Tebal Blade</th>
                        <th style="border: 1px solid #000; padding: 5px; text-align: center; width: 7%;">P Blade</th>
                        <th style="border: 1px solid #000; padding: 5px; text-align: center; width: 7%;">L Blade</th>
                        <th style="border: 1px solid #000; padding: 5px; text-align: center; width: 7%;">Jarak Blade</th>
                        <th style="border: 1px solid #000; padding: 5px; text-align: center; width: 7%;">Jumlah Spiral</th>
                        <th style="border: 1px solid #000; padding: 5px; text-align: center; width: 7%;">D Roll</th>
                        <th style="border: 1px solid #000; padding: 5px; text-align: center; width: 7%;">Daya Jepit</th>
                ...
                <tbody>
                    @forelse ($inspeksi_pound->inspeksiPoundWip as $wip)
                        <tr>
                            ...
                            <td style="border: 1px solid #000; padding: 4px; text-align: center;">{{ $wip->tebal_blade }}</td>
                            <td style="border: 1px solid #000; padding: 4px; text-align: center;">{{ $wip->p_blade }}</td>
                            <td style="border: 1px solid #000; padding: 4px; text-align: center;">{{ $wip->l_blade }}</td>
                            <td style="border: 1px solid #000; padding: 4px; text-align: center;">{{ $wip->jarak_blade }}</td>
                            <td style="border: 1px solid #000; padding: 4px; text-align: center;">{{ $wip->jml_spiral }}</td>
                            <td style="border: 1px solid #000; padding: 4px; text-align: center;">{{ $wip->d_roll }}</td>
                            <td style="border: 1px solid #000; padding: 4px; text-align: center;">{{ $wip->daya_jepit }}</td>
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p style="margin: 0; border-top: 1px solid #000; width: 200px; padding-top: 5px;">
                        {{ $inspeksi_pound->inspeksiPoundWip->first()->user->name ?? '.................' }}</p>
                ...
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <br><br><br>
                    <p style="margin: 0; border-top: 1px solid #000; width: 200px; padding-top: 5px;">
                        {{ $inspeksi_pound->approver->name ?? '.................' }}</p>
