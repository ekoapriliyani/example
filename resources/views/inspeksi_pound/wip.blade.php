    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <p class="text-sm text-gray-500">
                Ref: <span class="font-mono font-bold text-indigo-600">{{ $inspeksiPound->nomor_inspeksi }}</span>
            </p>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700">
                            ...
                            <strong>{{ $inspeksiPound->nomor_inspeksi }}</strong>.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200">
                <div class="p-8">
                    <form action="{{ route('inspeksi_pound_wip.store') }}" method="POST" enctype="multipart/form-data"
                        class="space-y-6">
                        @csrf
                        <input type="hidden" name="inspeksi_pound_id" value="{{ $inspeksiPound->id }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative mt-1">
                                    <x-text-input id="tebal_blade" name="tebal_blade" type="number" step="0.01"
                                        class="block w-full pr-12" :value="old('tebal_blade')" required placeholder="0.00" />
                                    <div
                            ...
                            <div>
                                ...
                                <div class="relative mt-1">
                                    <x-text-input id="p_blade" name="p_blade" type="number" step="0.01"
                                        class="block w-full pr-12" :value="old('p_blade')" required placeholder="0.00" />
                                    <div
                                        class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none text-gray-400 text-sm">
                                        mm
                                    </div>
                            ...
                            <div>
                                ...
                                <div class="relative mt-1">
                                    <x-text-input id="l_blade" name="l_blade" type="number" step="0.01"
                                        class="block w-full pr-12" :value="old('l_blade')" required placeholder="0.00" />
                                    <div
                                        class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none text-gray-400 text-sm">
                                        mm
                                    </div>
                            ...
                            <div>
                                ...
                                <div class="relative mt-1">
                                    <x-text-input id="jarak_blade" name="jarak_blade" type="number" step="0.01"
                                        class="block w-full pr-12" :value="old('jarak_blade')" required placeholder="0.00" />
                                    <div
                                        class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none text-gray-400 text-sm">
                                        mm
                                    </div>
                            ...
                            <div>
                                ...
                                <div class="relative mt-1">
                                    <x-text-input id="d_roll" name="d_roll" type="number" step="0.01"
                                        class="block w-full pr-12" :value="old('d_roll')" required placeholder="0.00" />
                                    <div
                                        class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none text-gray-400 text-sm">
                                        mm
                                    </div>
                            ...
                            <div>
                                ...
                                <select id="daya_jepit" name="daya_jepit"
                                    ...
                                    <option value="OK" {{ old('daya_jepit') == 'OK' ? 'selected' : '' }}>
                                        OK
                                    </option>
                                    <option value="NG" {{ old('daya_jepit') == 'NG' ? 'selected' : '' }}>
                                        NG
                                    </option>
                                </select>
                        ...
                        <div class="flex items-center justify-end gap-4 pt-6 border-t border-gray-100">
                            <a href="{{ route('inspeksi_pound.show', $inspeksiPound->id) }}"
