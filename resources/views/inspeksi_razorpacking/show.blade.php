    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold leading-tight text-gray-800">
                {{ __('Detail Inspeksi Razor Packing') }}
            </h2>
            <div class="flex gap-2">
                ...
                @php
                    $isApproved = $inspeksiRazorpacking->approval_status === 'APPROVED';
                @endphp
                <div class="flex items-center gap-2">
                    ...
                    @else
                        <a href="{{ route('inspeksi_razorpacking.fg', $inspeksiRazorpacking->id) }}"
                    ...
                    <div class="overflow-x-auto rounded-lg border border-gray-200">
                        <table class="min-w-full divide-y divide-gray-200 text-left text-sm">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                @forelse ($inspeksiRazorpacking->inspeksiRazorpackingFg as $fg)
                                    <tr class="transition-colors hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center gap-3">
                                                ...
                                                @else
                                                    <a href="{{ route('inspeksi_razorpacking_fg.edit', $fg->id) }}"
                                                ...
                                                @else
                                                    <form id="delete-form-{{ $fg->id }}"
                                                        action="{{ route('inspeksi_razorpacking_fg.destroy', $fg->id) }}"
                        ...
                        {{-- modal detail fg --}}
                        @foreach ($inspeksiRazorpacking->inspeksiRazorpackingFg as $fg)
                            <div id="detail-{{ $fg->id }}"
                ...
                <div class="p-6">
                    <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h3 class="text-xl font-bold text-gray-900">
                                    Approval Inspeksi Razor Packing
                                </h3>
                        ...
                        <div class="flex items-center gap-4">
                            <!-- Status -->
                            @if ($inspeksiRazorpacking->isApproved())
                                <span
                            ...
                            @if (in_array(auth()->user()->role, ['supervisor', 'manager', 'administrator']))
                                <form id="approval-form-{{ $inspeksiRazorpacking->id }}"
                                    action="{{ route('inspeksi-razorpacking.toggle', $inspeksiRazorpacking->id) }}"
                                    method="POST" class="hidden">
                                    @csrf
                                    @method('PATCH')
                                </form>
                                <button type="button"
                                    onclick="confirmApproval({{ $inspeksiRazorpacking->id }}, '{{ $inspeksiRazorpacking->isApproved() ? 'unapprove' : 'approve' }}')"
                                    class="{{ $inspeksiRazorpacking->isApproved()
    ...
    <div id="print-section" class="hidden">
            ...
            <tr>
                ...
                <td style="width: 60%; vertical-align: middle; text-align: center;">
                    <h1 style="font-size: 18pt; font-weight: bold; margin: 0; font-family: Arial, sans-serif;">LAPORAN
                        INSPEKSI HARIAN RAZOR PACKING</h1>
                </td>
                <td
        ...
        <table width="100%" cellpadding="5" cellspacing="0"
            ...
            <tr>
                ...
                <td style="width: 30%;">: {{ $inspeksiRazorpacking->nomor_inspeksi }}</td>
            </tr>
            <tr>
                <td style="font-weight: bold;">PRO Number</td>
                <td>: {{ $inspeksiRazorpacking->pro->pro_id }}</td>
                <td style="font-weight: bold;">Description</td>
                <td>: {{ $inspeksiRazorpacking->pro->description }}</td>
            </tr>
            <tr>
                <td style="font-weight: bold;">QTY Ordered</td>
                <td>: {{ $inspeksiRazorpacking->pro->qty }}</td>
                <td style="font-weight: bold;">Total Prod Per Shift</td>
                <td>: {{ $inspeksiRazorpacking->total_prod }} {{ $inspeksiRazorpacking->satuan }}</td>
            </tr>
            <tr>
                <td style="font-weight: bold;">Shift</td>
                <td>: {{ $inspeksiRazorpacking->shift }}</td>
                <td></td>
                <td></td>
            </tr>
        </table>
        ...
        <table width="100%" cellpadding="10" cellspacing="0"
            ...
            <tr>
                ...
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <br><br><br>
                    <p style="margin: 0; border-top: 1px solid #000; width: 200px; padding-top: 5px;">
                        {{ $inspeksiRazorpacking->approver->name ?? '.................' }}</p>
