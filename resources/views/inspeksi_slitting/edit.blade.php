                            ...
                            <div class="flex items-center space-x-2 mt-1">
                                ...
                                <div class="w-32">
                                    <select id="satuan" name="satuan"
                                        ...
                                        <option value="unit"
                                            {{ old('satuan', $inspeksi_slitting->satuan) == 'unit' ? 'selected' : '' }}>
                                            unit
                                        </option>
                                        <option value="pcs"
                                            {{ old('satuan', $inspeksi_slitting->satuan) == 'pcs' ? 'selected' : '' }}>
                                            pcs
                                        </option>
                                        <option value="kg"
                                            {{ old('satuan', $inspeksi_slitting->satuan) == 'kg' ? 'selected' : '' }}>
                                            kg
                                        </option>
                                        <option value="roll"
                                            {{ old('satuan', $inspeksi_slitting->satuan) == 'roll' ? 'selected' : '' }}>
                                            roll
                                        </option>
                                        <option value="lembar"
                                            {{ old('satuan', $inspeksi_slitting->satuan) == 'lembar' ? 'selected' : '' }}>
                                            lembar
                                        </option>
                                        <option value="ton"
                                            {{ old('satuan', $inspeksi_slitting->satuan) == 'ton' ? 'selected' : '' }}>
                                            ton
                                        </option>
                                    </select>
                                </div>
