    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden border border-gray-200 bg-white p-6 shadow-sm sm:rounded-lg">
                <form action="{{ route('inspeksi_slitting.index') }}" method="GET"
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200 bg-white text-sm">
                                ...
                                <tbody class="divide-y divide-gray-200">
                                                ...
                                                <div class="flex items-center justify-end gap-2">
                                                    ...
                                                    @if (!$item->isApproved())
                                                        ...
                                                        <form id="delete-form-{{ $item->id }}"
                                                            action="{{ route('inspeksi_slitting.destroy', $item->id) }}"
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="13" class="px-4 py-8 text-center italic text-gray-500">
