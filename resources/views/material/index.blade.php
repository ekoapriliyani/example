            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200">
                <div class="p-6">
                    ...
                    <p class="mt-2 text-xs text-gray-400 font-medium">* Format kolom: <span
                            class="text-indigo-600 italic">item_id, description</span> (ID akan dibuat otomatis)</p>
                </div>
            </div>

            <div class="mb-4">
                <form action="{{ route('material.index') }}" method="GET" class="flex gap-2">
                    <div class="relative flex-1 max-w-md">
                        ...
                        <input type="text" name="search" value="{{ request('search') }}"
                            ...
                            placeholder="Cari berdasarkan Item ID atau Deskripsi...">
                    </div>
                    <button type="submit"
                                    ...
                                    @forelse ($data as $item)
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td class="px-4 py-3 text-right whitespace-nowrap space-x-2">
                                                ...
                                                <button type="button"
                                                    onclick="confirmDelete({{ $item->id }}, '{{ $item->item_id }}')"
