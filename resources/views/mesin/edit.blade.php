            ...
            <form action="{{ route('mesin.update', $mesin->id) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="id_mesin" id="id_mesin"
                        class="mt-1 w-full rounded-md border-gray-200 shadow-sm sm:text-sm focus:border-indigo-500 focus:ring-indigo-500 @error('id_mesin') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <input type="text" name="nama_mesin" id="nama_mesin"
                        class="mt-1 w-full rounded-md border-gray-200 shadow-sm sm:text-sm focus:border-indigo-500 focus:ring-indigo-500 @error('nama_mesin') border-red-500 @enderror"
