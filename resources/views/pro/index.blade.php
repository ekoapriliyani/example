            ...
            {{-- <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200">
                <div class="p-6">
                    <h3 class="text-sm font-bold text-gray-700 uppercase mb-4 flex items-center gap-2">
                        ...
                        Import PRO via Excel
                    </h3>

                    <form action="{{ route('pro.import') }}" method="POST" enctype="multipart/form-data"
                ...
                <form action="{{ route('pro.index') }}" method="GET" class="flex gap-2">
                    <div class="relative flex-1 max-w-md">
                        ...
                        <input type="text" name="search" value="{{ request('search') }}"
                            ...
                            placeholder="Cari berdasarkan PRO ID atau Deskripsi...">
                    </div>
                    <button type="submit"
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    @forelse ($data as $pro)
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td class="px-4 py-3 text-gray-700">{{ $pro->qty }}</td>
