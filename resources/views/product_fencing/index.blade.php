    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Daftar Produk Fencing
            </h2>

            <a href="{{ route('productfencing.create') }}"
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200">
                <div class="p-6">
                    <h3 class="text-sm font-bold text-gray-700 uppercase mb-4 flex items-center gap-2">
                        ...
                        Import Product Fencing via Excel
                    </h3>

                    <form action="{{ route('productfencing.import') }}" method="POST" enctype="multipart/form-data"
                                ...
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-4 py-3 font-semibold text-gray-900 text-right whitespace-nowrap">
                                            Action</th>
                                        <th class="px-4 py-3 font-semibold text-gray-900 text-left">Product Fencing ID
                                        </th>
                                        <th class="px-4 py-3 font-semibold text-gray-900 text-left">Description</th>
                                        <th class="px-4 py-3 font-semibold text-gray-900 text-left">D 1</th>
                                        <th class="px-4 py-3 font-semibold text-gray-900 text-left">D 2
                                        </th>
                                        <th class="px-4 py-3 font-semibold text-gray-900 text-left">D Tol 2</th>
                                        <th class="px-4 py-3 font-semibold text-gray-900 text-left">D Tol 2</th>
                                        <th class="px-4 py-3 font-semibold text-gray-900 text-left">P Sebelum</th>
                                        <th class="px-4 py-3 font-semibold text-gray-900 text-left">P Sesudah</th>
                                        <th class="px-4 py-3 font-semibold text-gray-900 text-left">L Sebelum</th>
                                        <th class="px-4 py-3 font-semibold text-gray-900 text-left">L Sesudah</th>
                                    </tr>
                                </thead>
                                    ...
                                    @forelse ($data as $item)
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td class="px-4 py-3 text-right whitespace-nowrap space-x-2">
                                                <a href="{{ route('productfencing.show', $item->id) }}"
                                                ...
                                                <form id="delete-form-{{ $item->id }}"
                                                    action="{{ route('productfencing.destroy', $item->id) }}"
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="3" class="px-4 py-8 text-center text-gray-500 italic">
                                                Belum ada data produk Fencing. Silakan tambah produk baru.
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
