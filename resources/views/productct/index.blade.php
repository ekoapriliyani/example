            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200">
                <div class="p-6">
                    <h3 class="text-sm font-bold text-gray-700 uppercase mb-4 flex items-center gap-2">
                        ...
                        Import Product CTCL via Excel
                    </h3>

                    <form action="{{ route('productct.import') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <table class="min-w-full divide-y divide-gray-200 bg-white text-sm">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-4 py-3 font-semibold text-gray-900 text-left">Product CTCL ID</th>
                                        ...
                                        <th class="px-4 py-3 font-semibold text-gray-900 text-left">L2 Mesh</th>
                                    ...
                                    @forelse ($data as $item)
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td class="px-4 py-3 text-right whitespace-nowrap space-x-2">
                                                <a href="{{ route('productct.show', $item->id) }}"
                                                ...
                                                <form id="delete-form-{{ $item->id }}"
                                                    action="{{ route('productct.destroy', $item->id) }}" method="POST"
                                                    class="hidden">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="3" class="px-4 py-8 text-center text-gray-500 italic">
                                                Belum ada data produk CT. Silakan tambah produk baru.
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
