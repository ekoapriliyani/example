                ...
                <div class="p-8 text-gray-900">
                    ...
                    <form action="{{ route('productwm.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="jenis_wm" name="jenis_wm" type="text" class="mt-1 block w-full"
                                :value="old('jenis_wm')" placeholder="" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="d_kawat" name="d_kawat" type="text" class="mt-1 block w-full"
                        ...
                        <div>
                            ...
                            <x-text-input id="tol_min_d" name="tol_min_d" type="text" class="mt-1 block w-full"
                        ...
                        <div>
                            ...
                            <x-text-input id="tol_max_d" name="tol_max_d" type="text" class="mt-1 block w-full"
                        ...
                        <div>
                            ...
                            <x-text-input id="p_product" name="p_product" type="text" class="mt-1 block w-full"
                        ...
                        <div>
                            ...
                            <x-text-input id="l_product" name="l_product" type="text" class="mt-1 block w-full"
                        ...
                        <div>
                            ...
                            <x-text-input id="p_mesh" name="p_mesh" type="text" class="mt-1 block w-full"
                        ...
                        <div>
                            ...
                            <x-text-input id="l_mesh" name="l_mesh" type="text" class="mt-1 block w-full"
                        ...
                        <div>
                            ...
                            <x-text-input id="tol_mesh" name="tol_mesh" type="text" class="mt-1 block w-full"
