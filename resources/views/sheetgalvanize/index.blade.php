    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Daftar Inspeksi Incoming Sheet Galvanized') }}
            </h2>

            <a href="{{ route('sheetgalvanize.create') }}"
                ...
                Tambah Inspeksi Sheet Galvanized
            </a>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200 p-6">
                <form action="{{ route('sheetgalvanize.index') }}" method="GET"
                    ...
                    <div class="relative flex-1 min-w-[250px]">
                        ...
                        <input type="text" name="search" id="search" value="{{ request('search') }}"
                            ...
                            placeholder="Cari nomor inspeksi, PO, supplier...">
                    </div>
