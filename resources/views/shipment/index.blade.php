<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="mb-4">
                <form action="{{ route('shipment.index') }}" method="GET" class="flex gap-2">
                    <div class="relative flex-1 max-w-md">
                        ...
                        <input type="text" name="search" value="{{ request('search') }}"
                            ...
                            placeholder="Cari berdasarkan Shipment ID atau Deskripsi...">
                    </div>
                    <button type="submit"
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    @forelse ($data as $shipment)
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">
                                                {{ $shipment->shipment_id }}</td>
                                            <td class="px-4 py-3 text-gray-700">{{ $shipment->description }}</td>
                                            <td class="px-4 py-3 text-gray-700">{{ $shipment->qty }}</td>
                                            <td class="px-4 py-3 text-right whitespace-nowrap space-x-2">
                                                ...
                                                <button type="button"
                                                    onclick="confirmDelete({{ $shipment->id }}, '{{ $shipment->shipment_id }}')"
