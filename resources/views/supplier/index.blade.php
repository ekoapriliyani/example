                            ...
                            <table class="min-w-full divide-y divide-gray-200 bg-white text-sm">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-4 py-3 font-semibold text-gray-900 whitespace-nowrap text-left">Supplier ID</th>
                                        <th class="px-4 py-3 font-semibold text-gray-900 text-left">Nama Supplier</th>
