        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                    {{ __('Detail Informasi Supplier') }}
                </h2>
                <p class="mt-1 text-sm text-gray-500">xxxx</p>
            </div>
                ...
                <div class="p-6 sm:p-8 text-gray-900">
                    <dl class="-my-3 divide-y divide-gray-100 text-sm">
                        <div class="grid grid-cols-1 gap-1 py-4 sm:grid-cols-3 sm:gap-4">
                            <dt class="font-semibold text-gray-900">Supplier ID</dt>
                        ...
                        <div class="grid grid-cols-1 gap-1 py-4 sm:grid-cols-3 sm:gap-4">
                            <dt class="font-semibold text-gray-900">Nama Supplier</dt>
                            <dd class="text-gray-700 text-base sm:col-span-2">{{ $supplier->nama }}</dd>
                        </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-red-200">
                <div class="p-4 bg-red-50 flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xs text-red-600 mt-1">Data supplier ini akan dihapus secara permanen dari sistem.
                        </p>
                    </div>
                    ...
                    <form id="delete-form-{{ $supplier->id }}" action="{{ route('supplier.destroy', $supplier->id) }}"
                        ...
                        @csrf
                        @method('DELETE')
                        <button type="button" onclick="confirmDelete({{ $supplier->id }}, '{{ $supplier->nama_supplier }}')"
    ...
    <script>
        function confirmDelete(id, name) {
            Swal.fire({
                ...
                text: "supplier " + name + " akan dihapus secara permanen!",
                icon: 'warning',
